...
var options1 = {
  ...
  labels: ['12', '13', '14', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
  xaxis: {
    axisBorder: {
      show: false
    },
...
var options = {
    ...
    colors: ['#5c1ac3', '#e2a03f', '#e7515a', '#39C306'],
    dataLabels: {
      enabled: false
    },
    legend: {
    ...
    series: [985, 737, 270, 225],
    labels: ['Customers', 'Agents', 'Corporates', 'Distributors'],
    responsive: [{
        breakpoint: 1599,
        options: {
            chart: {
