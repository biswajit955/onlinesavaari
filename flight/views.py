...
def review_flight(request):
    ...
    if (radio1 == "one-way"):
        ...
        if(rtype == "spicejet"):
            ...
            spice_serach = json.loads(json.dumps(spice_serach).replace('s:', "").replace('a:', ""))
            apiamount = spice_serach['Envelope']['Body']['PriceItineraryResponse']['Booking']['BookingSum']['BalanceDue']
            context= {
                "radio1":radio1,
                "Person":Person,
                "rtype":rtype,
